  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-lg glass-panel p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <input name="fullName" defaultValue={contact.full_name} placeholder="Full name *" required
              ...
              <input name="company" defaultValue={contact.company ?? ""} placeholder="Company"
                className="input-field" />
              <input name="website" type="url" defaultValue={contact.website ?? ""} placeholder="Website"
                className="input-field" />
            ...
            <textarea name="notes" defaultValue={contact.notes ?? ""} placeholder="Notes" rows={3}
            ...
            {state?.duplicates && state.duplicates.length > 0 && (
              <div className="rounded-lg border border-yellow-400/30 bg-yellow-400/5 p-3 text-xs">
                ...
                <button type="submit" name="confirmed" value="true"
                  className="text-yellow-300 underline">Save anyway</button>
              </div>
            )}
