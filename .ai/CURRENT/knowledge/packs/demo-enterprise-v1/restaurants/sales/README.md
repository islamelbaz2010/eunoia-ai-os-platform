...
**Schema Type**: `offer.schema.json`

## Purpose

Sales processes, pipelines, offers, and customer acquisition frameworks
...
| File | Purpose |
|------|---------|
| `schema.json` | JSON Schema for this department — extends `offer.schema.json` |
...
The canonical schema for this department is `offer.schema.json`, located at:
```
knowledge/schemas/offer.schema.json
```
