...
**Schema Type**: `campaign.schema.json`

## Purpose

Marketing campaigns, brand guidelines, persona definitions, and content strategy
...
| File | Purpose |
|------|---------|
| `schema.json` | JSON Schema for this department — extends `campaign.schema.json` |
...
The canonical schema for this department is `campaign.schema.json`, located at:
```
