...
**Schema Type**: `kpi.schema.json`

## Purpose

KPI definitions, reporting structures, and performance metric frameworks
...
| File | Purpose |
|------|---------|
| `schema.json` | JSON Schema for this department — extends `kpi.schema.json` |
...
The canonical schema for this department is `kpi.schema.json`, located at:
```
knowledge/schemas/kpi.schema.json
```
