...
**Schema Type**: `playbook.schema.json`

## Purpose

Customer support procedures, escalation paths, and resolution workflows
...
| File | Purpose |
|------|---------|
| `schema.json` | JSON Schema for this department — extends `playbook.schema.json` |
...
The canonical schema for this department is `playbook.schema.json`, located at:
```
knowledge/schemas/playbook.schema.json
```
