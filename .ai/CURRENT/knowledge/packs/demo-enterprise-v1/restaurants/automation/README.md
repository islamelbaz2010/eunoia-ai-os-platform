...
**Schema Type**: `automation.schema.json`

## Purpose

Workflow automation specifications, trigger definitions, and action mappings
...
| File | Purpose |
|------|---------|
| `schema.json` | JSON Schema for this department — extends `automation.schema.json` |
...
The canonical schema for this department is `automation.schema.json`, located at:
```
knowledge/schemas/automation.schema.json
```
