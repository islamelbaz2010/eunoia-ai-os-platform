# Restaurants Knowledge Pack

**Pack**: Demo Enterprise Pack v1 (`demo-enterprise-v1`)
**Industry ID**: `restaurants`
**Industry Code**: `RST`
**NAICS Code**: `722511`
**Domains**: `food-service`, `kitchen-operations`, `front-of-house`, `menu-management`

## Description

Food service and restaurant operations knowledge framework
