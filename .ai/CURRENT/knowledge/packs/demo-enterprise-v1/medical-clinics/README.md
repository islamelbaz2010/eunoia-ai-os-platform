# Medical Clinics Knowledge Pack

**Pack**: Demo Enterprise Pack v1 (`demo-enterprise-v1`)
**Industry ID**: `medical-clinics`
**Industry Code**: `MED`
**NAICS Code**: `621111`
**Domains**: `patient-care`, `clinical-operations`, `compliance`, `scheduling`

## Description

Primary care and specialty clinic knowledge framework
