 ...
 *
 * Prompts are never hardcoded. Every prompt is assembled at runtime from:
 ...
 * Gemini, Claude, OpenAI, or any future LLM.
 */
 ...
 * The prompt is deterministic for the same context — suitable for caching and replay.
 */
 ...
 * Includes the original output and the specific errors to fix.
 */
...
/**
 * Serialize a prompt to a loggable string (truncated system prompt for brevity).
 */
